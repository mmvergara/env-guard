      ...
      <section className="flex h-fit flex-wrap gap-2">
        {
          ...
          Array.from({ length: 200 }).map((_, idx) => (
            <article className="group flex h-[110px] w-[235px] grow cursor-pointer flex-col justify-between  rounded-lg border-[2px] border-white bg-zinc-100 p-2 text-black transition-colors hover:border-blueMain hover:border-opacity-40 ">
